  ...
  return (
    ...
    <h2 style={{marginLeft:"15%" , position:'relative'}}>Add Member</h2>
      <form onSubmit={handleSubmit(sendData)} style={{alignSelf:'center',position:'relative'}}>
        ...
        <input type='number' {...register('member_mob_no')} placeholder={"Enter Mobile Number"} required/><br/>
        ...
        <input type='date' {...register('member_DOB')} placeholder={"Enter DOB"} required/><br/>

        <label>Date Of Joining : </label>
        <input type='date' {...register('member_DOJoining')} placeholder={"Enter DOJ"} required/><br/>
